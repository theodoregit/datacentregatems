      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">View Approved Requests</a>
          </div>
        </div>
      </li>
    </ul>
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{route('dc-reception-request-details', ['requestno' => preg_replace('/[^a-zA-Z0-9\s]/', '', $approved_request->requestno)])}}" class="btn btn-info btn-sm">Details</a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>

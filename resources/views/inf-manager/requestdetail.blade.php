      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('requests-confirmed')}}">View Confirmed Requests</a>
            <a class="collapse-item" href="{{route('request-form-inf')}}">Fill Request Form</a> 
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <form action="{{route('inf-manager.approve-requests')}}" method="post">
                    {{csrf_field()}}
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group" action="{{route('inf-manager.reject-requests')}}" method="post">
                        ...
                        <textarea name="denial_reason" class="form-control" id="" cols="30" rows="3" placeholder="State your reason to reject this request ..."></textarea>
                </div>
                <div class="modal-footer">

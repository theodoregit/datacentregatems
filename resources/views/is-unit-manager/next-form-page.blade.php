                          ...
                          <div class="row">
                            ...
                            <div class="form-group" id="simple-date4">
                              ...
                              <div class="input-daterange input-group">
                                ...
                                <input type="text" class="input-sm form-control" name="enddate" placeholder="end(not including)"/>
                              </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row form-group field_wrapper">
                        ...
                        <div class="col-lg-2">
                          ...
                          <textarea name="escorts" class="form-control" id="" cols="30" rows="4.5"
                            style="margin-top: 0px; margin-bottom: 0px; height: 43px;" placeholder="separate with comma"></textarea> 
                        </div>
                        <div class="col-lg-6">
                          ...
                          style="margin-top: 0px; margin-bottom: 0px; height: 119px;"></textarea>
                        </div>
                    </div><hr>
                    <div class="row form-group">
                        <div class="col-lg-12">

...
Route::prefix('/')->middleware(['super-admin'])->group(function(){
    ...
    Route::get('add-new-user', 'AccountsController@addUser')->name('add-new-user');
    Route::post('add-new-user', 'AccountsController@createNewUser')->name('add-new-user.submit');
    ...
    Route::get('manage-datacentres', 'AdminController@manageDataCentre')->name('manage-datacentres');
});
...
//inf manager
Route::prefix('/inf-manager')->middleware(['inf-manager'])->group(function(){
...
Route::prefix('/dc-admin')->middleware(['dc-admin'])->group(function(){
    ...
    Route::get('/track-requests/{requestno}', 'DCAdminsController@trackRequest')->name('track-request');
    Route::post('track-request/track', 'DCAdminsController@track')->name('track');
});
...
Route::prefix('/all-login')->group(function(){
    Route::post('/', 'Auth\UnitManagerLoginController@login')->name('unit-manager.login.submit');
});
Route::post('/all-login', 'Auth\LoginController@login')->name('all-login');
/*
